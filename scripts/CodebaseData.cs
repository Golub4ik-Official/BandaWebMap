    ...
    public class CodebaseData {
        ...
        public static Dictionary<string, Codebase> Codebases = new Dictionary<string, Codebase>() {
            ...
            { "arkstation", new Codebase {
                ...
                GameMaps = new List<GameMap>() {
                    new GameMap { MapId = "blueshift", MapName = "Blueshift", Layers = new List<string[]> {
                            ...
                            new string[] { "Lower Deck", "Blueshift", "1" },
                        }
                    },
                    ...
                    new GameMap { MapId = "icebox", MapName = "Ice Box", Layers = new List<string[]> {
                            new string[] { "Ground", "IceBoxStation", "3" },
                            new string[] { "Underground", "IceBoxStation", "2" },
                            new string[] { "Caves", "IceBoxStation", "1" },
                        }
                    },
                    ...
                    new GameMap { MapId = "northstar", MapName = "North Star", Layers = new List<string[]> {
                            new string[] { "Upper Deck", "north_star", "4" },
                            new string[] { "Second Deck", "north_star", "3" },
                            new string[] { "Third Deck", "north_star", "2" },
                            new string[] { "Lower Deck", "north_star", "1" },
                        }
                    },
                    new GameMap { MapId = "omega", MapName = "OmegaStation", Layers = new List<string[]> {
                            new string[] { "Ground", "OmegaStation", "3" },
                            new string[] { "Underground", "OmegaStation", "2" },
                            new string[] { "Caves", "OmegaStation", "1" },
                        }
                    },
                    new GameMap { MapId = "ouroboros", MapName = "Ouroboros", Layers = new List<string[]> {
                            new string[] { "Upper Deck", "Ouroboros", "2" },
                            new string[] { "Lower Deck", "Ouroboros", "1" },
                        }
                    },
                    ...
                    new GameMap { MapId = "serenity", MapName = "Serenity", Layers = new List<string[]> {
                            new string[] { "Space Dock", "SerenityStation", "3" },
                            new string[] { "Ground", "SerenityStation", "2" },
                            new string[] { "Mushroom Caves", "SerenityStation", "1" },
                        }
                    },
                    new GameMap { MapId = "snowglobe", MapName = "Snowglobe", Layers = new List<string[]> {
                            new string[] { "Ground", "snowglobe", "3" },
                            new string[] { "Underground", "snowglobe", "2" },
                            new string[] { "Caves", "snowglobe", "1" },
                        }
                    },
                    new GameMap { MapId = "tram", MapName = "TramStation", Layers = new List<string[]> {
                            new string[] { "Upper Deck", "tramstation", "2" },
                            new string[] { "Lower Deck", "tramstation", "1" },
                        }
                    },
                    ...
                    new GameMap { MapId = "wawa", MapName = "WawaStation", Layers = new List<string[]> {
                            new string[] { "Upper Deck", "wawastation", "2" },
                            new string[] { "Lower Deck", "wawastation", "1" },
                        }
                    },
                }
            } },
            ...
            { "cm", new Codebase {
                ...
                GameMaps = new List<GameMap>() {
                    new GameMap { MapId = "almayer", MapName = "USS Almayer", MapWidth = 300, MapHeight = 101,
                        Layers = new List<string[]> {
                            new string[] { "Upper Deck", "USS_Almayer", "4" },
                            new string[] { "Middle Deck", "USS_Almayer", "3" },
                            new string[] { "Lower Deck", "USS_Almayer", "2" },
                            new string[] { "Under Deck", "USS_Almayer", "1" },
                        }
                    },
                    ...
                    new GameMap { MapId = "kutjevo", MapName = "Kutjevo Refinery", MapWidth = 240, MapHeight = 165,
                        Layers = new List<string[]> {
                            ...
                            new string[] { "Sky", "Kutjevo", "2" },
                        }
                    },
                    new GameMap { MapId = "lv522", MapName = "LV522", MapWidth = 193, MapHeight = 204,
                        Layers = new List<string[]> {
                            new string[] { "Main Level", "LV522_Chances_Claim", "1" },
                            new string[] { "Sky", "LV522_Chances_Claim", "2" },
                        }
                    },
                    new GameMap { MapId = "lv624", MapName = "LV624", MapWidth = 175, MapHeight = 222,
                        Layers = new List<string[]> {
                            new string[] { "Main Level", "LV624", "1" },
                            new string[] { "Sky", "LV624", "2" },
                        }
                    },
                    new GameMap { MapId = "lv759", MapName = "LV759", MapWidth = 225, MapHeight = 250,
                        Layers = new List<string[]> {
                            new string[] { "Main Level", "LV759_Hybrisa_Prospera", "1" },
                            new string[] { "Sky", "LV759_Hybrisa_Prospera", "2" },
                        }
                    },
                    new GameMap { MapId = "newvaradero", MapName = "New Varadero", MapWidth = 220, MapHeight = 180,
                        Layers = new List<string[]> {
                            new string[] { "Main Level", "New_Varadero", "1" },
                            new string[] { "Sky", "New_Varadero", "2" },
                        }
                    },
                    new GameMap { MapId = "shivas", MapName = "Shivas Snowball", MapWidth = 222, MapHeight = 162,
                        Layers = new List<string[]> {
                            new string[] { "Main Level", "Shivas_Snowball", "1" },
                            new string[] { "Sky", "Shivas_Snowball", "2" },
                        }
                    },
                    new GameMap { MapId = "solaris", MapName = "Solaris Ridge", MapWidth = 223, MapHeight = 211,
                        Layers = new List<string[]> {
                            new string[] { "Main Level", "BigRed", "1" },
                            new string[] { "Sky", "BigRed", "2" },
                        }
                    },
                    new GameMap { MapId = "sorokyne", MapName = "Sorokyne Strata", MapWidth = 256, MapHeight = 173,
                        Layers = new List<string[]> {
                            new string[] { "Main Level", "Sorokyne_Strata", "1" },
                            new string[] { "Sky", "Sorokyne_Strata", "2" },
                        }
                    },
                    new GameMap { MapId = "trijent", MapName = "Trijent Dam", MapWidth = 245, MapHeight = 232,
                        Layers = new List<string[]> {
                            new string[] { "Underground", "Desert_Dam", "1" },
                            new string[] { "Main Level", "Desert_Dam", "2" },
                            new string[] { "Lower Sky", "Desert_Dam", "3" },
                            new string[] { "Sky", "Desert_Dam", "4" },

                        }
                    },
                    new GameMap { MapId = "tyragorift", MapName = "Tyrargo Rift", MapWidth = 241, MapHeight = 182,
                        Layers = new List<string[]> {
                            new string[] { "Underground", "Tyrargo_Rift", "1" },
                            new string[] { "Main Level", "Tyrargo_Rift", "2" },
                            new string[] { "Sky", "Tyrargo_Rift", "3" },
            ...
            { "paradise", new Codebase {
                ...
                GameMaps = new List<GameMap>() {
                    ...
                    new GameMap { MapId = "omegastation", MapName = "OmegaStation (NSS Legaria)", Layers = new List<string[]> {
                            new string[] { "Base Map", "omegastation", "1" },
                        }
                    },
                }
            ...
            // SurfShack13
            { "surfshack", new Codebase {
                CodebaseId = "surfshack",
                CodebaseName = "SurfShack13",
                FancySupport = false,
                IsAdult = false,
                GameMaps = new List<GameMap>() {
                    new GameMap { MapId = "box", MapName = "BoxStation", Layers = new List<string[]> {
                            new string[] { "Base Map", "BoxStation", "1" },
                        }
                    },
                    new GameMap { MapId = "minisurf", MapName = "MiniSurf", Layers = new List<string[]> {
                            new string[] { "Base Map", "MiniSurf", "1" },
                        }
                    },
                    new GameMap { MapId = "pubby", MapName = "PubbyStation", Layers = new List<string[]> {
                            new string[] { "Base Map", "PubbyStation", "1" },
